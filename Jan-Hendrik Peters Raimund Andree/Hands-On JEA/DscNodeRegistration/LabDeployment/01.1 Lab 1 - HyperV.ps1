...
Add-LabIsoImageDefinition -Name SQLServer2016 -Path D:\LabSources\ISOs\en_sql_server_2016_enterprise_x64_dvd_8701793.iso
...
Get-ChildItem -Path 'C:\Users\JHP\Source\Repos\DSC Demo Project 1\LabDeployment' | Where-Object { $_.Name -match '^\d{2} [\w ]+\.ps1' } | ForEach-Object {
